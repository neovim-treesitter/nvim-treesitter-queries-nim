...
[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-nim/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-nim/actions/workflows/validate.yml)

Neovim tree-sitter queries for **nim**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-nim",
...
- [ ] Changes are scoped to `nim` — do not include files for other languages
